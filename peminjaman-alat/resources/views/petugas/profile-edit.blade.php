...
@section('title', 'Edit Profile Petugas')
...
<div class="max-w-5xl mx-auto px-4 py-6">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
            <div class="mb-4 md:mb-0">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Edit Profil Petugas</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                    ...
                    <div class="flex justify-end pt-4 border-t">
                        <button 
                            type="submit"
                            class="px-6 py-2.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg"
                        >
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                    ...
                    <div class="flex justify-end pt-4 border-t">
                        <button 
                            type="submit"
                            class="px-6 py-2.5 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg"
                        >
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
        ...
        <div class="lg:col-span-1">
                ...
                <div class="space-y-3">
                    <div class="flex items-center p-3 bg-red-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900">Petugas Peminjaman</p>
                        </div>
                    </div>
            ...
            <!-- Quick Tips -->
            <div class="mt-6 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl shadow-sm border border-orange-200 p-6">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <span class="text-sm text-gray-700">Gunakan password yang kuat dengan kombinasi huruf, angka, dan simbol</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-green-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="text-sm text-gray-700">Jangan bagikan password dengan siapapun</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-green-500 mt-0.5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="text-sm text-gray-700">Selalu logout setelah selesai menggunakan sistem</span>
                    </li>
                </ul>
            </div>
        </div>
