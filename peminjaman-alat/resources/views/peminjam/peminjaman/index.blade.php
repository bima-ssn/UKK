...
<div>
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('peminjam.peminjaman.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Ajukan Peminjaman
        </a>
    </div>
                    ...
                    @forelse($peminjamans as $peminjaman)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('peminjam.peminjaman.show', $peminjaman) }}" class="text-blue-600 hover:text-blue-900">Detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">Belum ada peminjaman</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
